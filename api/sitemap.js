...
const STATIC_PAGES = [
  ...
  { path: '/breathe', priority: '0.8', changefreq: 'daily' },
  { path: '/breathe/how-to-deal-with-breakup', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/how-to-stop-overthinking', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/toxic-relationship-signs', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/feeling-lonely-what-to-do', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/self-love-after-heartbreak', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/anxiety-at-night-cant-sleep', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/burnout-hate-my-job', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/how-to-trust-again', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/what-to-do-when-feeling-lost', priority: '0.7', changefreq: 'weekly' },
  { path: '/breathe/how-to-express-emotions', priority: '0.7', changefreq: 'weekly' },
];
